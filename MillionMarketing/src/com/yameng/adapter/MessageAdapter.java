...
public class MessageAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null
			...
			if (isComMsg) {
				convertView = mInflater.inflate(R.layout.way_chat_item_left, null);
			} else {
				convertView = mInflater.inflate(R.layout.way_chat_item_right, null);
			}
...
/*		holder.head.setBackgroundResource(MyApplication.heads[item
				.getHeadImg()]);

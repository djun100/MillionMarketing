...
import com.yameng.bean.Message;
...
public class MyApplication extends Application implements PushMessageReceiver.EventHandler{
	private static final String TAG = "MyApplication";
	public final static String API_KEY = "YlxRkMiEDMQP7w4GLg10faOP";
	public final static String SECRIT_KEY = "5nk9q7ogz9bEYbMbcUYiN5sGhPmYCz7V";
	public static final String SP_FILE_NAME = "push_msg_sp";
	private static MyApplication instance;
	private BaiduPush mBaiduPushServer;
	public static ArrayList<Person> personL1;// 我的上线
	public static ArrayList<Person> personL1s;// 我的下线
	public static ArrayList<Person> personL2;// 我的上线的上线
	public static ArrayList<Person> personsL2s;// 我的下线的下线
	public static ArrayList<Person> personL3;// 我的上线的上线的上线
	public static ArrayList<Person> personsL3;// personL2的下线(我的上线的同级)
	public static ArrayList<Person> personsL3s;// personsL2s的下线
	public static String path_portrait= Environment.getExternalStorageDirectory().getPath()+"/yameng/portrait.png";//头像保存位置

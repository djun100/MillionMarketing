...
public class Activity_State_Release extends Activity {

	private Button bt_listing_status_return;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.state_of_the_release);

		bt_listing_status_return = (Button) findViewById(R.id.bt_listing_status_return);
		bt_listing_status_return.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				Intent intent = new Intent(Activity_State_Release.this,
	...
	private void initialButton() {
		...
		btn_shortcut_position.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(Activity_State_Release.this,
	...
	protected Animation setAnimScale(float toX, float toY) {
		animationScale = new ScaleAnimation(1f, toX, 1f, toY,
				...
				0.45f);
		animationScale.setInterpolator(Activity_State_Release.this,

...
public class Activity_Personal_Friend_Center extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_personal_friend_center);
	...
	private void initialButton() {
		...
		btn_shortcut_position.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(Activity_Personal_Friend_Center.this,
		...
		btn_shortcut_myaccount.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(Activity_Personal_Friend_Center.this,
	...
	protected Animation setAnimScale(float toX, float toY) {
		animationScale = new ScaleAnimation(1f, toX, 1f, toY,
				...
				0.45f);
		animationScale.setInterpolator(Activity_Personal_Friend_Center.this,

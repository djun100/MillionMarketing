...
public class Activity_Subpage_Fund extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_subpage_fund);
		...
		bt_friend_return.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(Activity_Subpage_Fund.this,
						MainActivity.class);
	...
	private void initialButton() {
		...
		btn_shortcut_position.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(Activity_Subpage_Fund.this,
	...
	protected Animation setAnimScale(float toX, float toY) {
		animationScale = new ScaleAnimation(1f, toX, 1f, toY,
				...
				0.45f);
		animationScale.setInterpolator(Activity_Subpage_Fund.this,

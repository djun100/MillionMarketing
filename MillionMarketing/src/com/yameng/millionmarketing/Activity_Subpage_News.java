...
public class Activity_Subpage_News extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_subpage_news);

		initViewPager();
		initialButton();
		// 返回
		bt_news_return = (Button) findViewById(R.id.bt_news_return);
		bt_news_return.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				Intent intent = new Intent(Activity_Subpage_News.this,
						MainActivity.class);
	...
	private void initViewPager() {
		...
		img1.setBackgroundResource(R.drawable.yameng_one);
		advPics.add(img1);

		ImageView img2 = new ImageView(this);
		img2.setBackgroundResource(R.drawable.yameng_two);
		advPics.add(img2);

		ImageView img3 = new ImageView(this);
		img3.setBackgroundResource(R.drawable.yameng_three);
		advPics.add(img3);

		ImageView img4 = new ImageView(this);
		img4.setBackgroundResource(R.drawable.advertising_default_fund);
		advPics.add(img4);
	...
	private void initialButton() {
		...
		btn_shortcut_position.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(Activity_Subpage_News.this,
	...
	protected Animation setAnimScale(float toX, float toY) {
		animationScale = new ScaleAnimation(1f, toX, 1f, toY,
				...
				0.45f);
		animationScale.setInterpolator(Activity_Subpage_News.this,

...
public class Activity_Subpage_Barter extends Activity {
	...
	private Button bt_barter_return;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_subpage_barter);

		initViewPager();
		initialButton();

		// 返回
		bt_barter_return = (Button) findViewById(R.id.bt_barter_return);
		bt_barter_return.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				Intent intent = new Intent(Activity_Subpage_Barter.this,
						MainActivity.class);
	...
	private void initViewPager() {
		...
		img4.setBackgroundResource(R.drawable.barter_theme);
		advPics.add(img4);
	...
	private void initialButton() {
		...
		btn_shortcut_position.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(Activity_Subpage_Barter.this,
	...
	protected Animation setAnimScale(float toX, float toY) {
		animationScale = new ScaleAnimation(1f, toX, 1f, toY,
				...
				0.45f);
		animationScale.setInterpolator(Activity_Subpage_Barter.this,

...
public class Activity_Subpage_Travel extends Activity {

	private Button bt_travel_return;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_subpage_travel);

		initialButton();

		// 返回
		bt_travel_return = (Button) findViewById(R.id.bt_travel_return);
		bt_travel_return.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				Intent intent = new Intent(Activity_Subpage_Travel.this,
						MainActivity.class);
	...
	private void initialButton() {
		...
		btn_shortcut_position.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(Activity_Subpage_Travel.this,
	...
	protected Animation setAnimScale(float toX, float toY) {
		animationScale = new ScaleAnimation(1f, toX, 1f, toY,
				...
				0.45f);
		animationScale.setInterpolator(Activity_Subpage_Travel.this,
